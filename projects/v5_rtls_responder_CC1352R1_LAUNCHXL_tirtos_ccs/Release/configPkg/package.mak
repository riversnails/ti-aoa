...
.dlls,em4f .dlls: rtls_responder_app.pem4f

-include package/cfg/rtls_responder_app_pem4f.mak
-include package/cfg/rtls_responder_app_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/rtls_responder_app_pem4f.dep
endif
rtls_responder_app.pem4f: package/cfg/rtls_responder_app_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
rtls_responder_app.pem4f package/cfg/rtls_responder_app_pem4f.c: .libraries,em4f
endif

package/cfg/rtls_responder_app_pem4f.c package/cfg/rtls_responder_app_pem4f.h package/cfg/rtls_responder_app_pem4f.xdl: override _PROG_NAME := rtls_responder_app.xem4f
package/cfg/rtls_responder_app_pem4f.c: package/cfg/rtls_responder_app_pem4f.cfg
package/cfg/rtls_responder_app_pem4f.xdc.inc: package/cfg/rtls_responder_app_pem4f.xdl
package/cfg/rtls_responder_app_pem4f.xdl package/cfg/rtls_responder_app_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/rtls_responder_app_pem4f.cfg
	-$(RM) package/cfg/rtls_responder_app_pem4f.dep
	-$(RM) package/cfg/rtls_responder_app_pem4f.c
	-$(RM) package/cfg/rtls_responder_app_pem4f.xdc.inc

clean,em4f::
	-$(RM) rtls_responder_app.pem4f
.executables,em4f .executables: rtls_responder_app.xem4f

rtls_responder_app.xem4f: |rtls_responder_app.pem4f

-include package/cfg/rtls_responder_app.xem4f.mak
rtls_responder_app.xem4f: package/cfg/rtls_responder_app_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/rtls_responder_app_pem4f.oem4f   package/cfg/rtls_responder_app_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
rtls_responder_app.xem4f: export C_DIR=
rtls_responder_app.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
rtls_responder_app.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

rtls_responder_app.test test,em4f test: rtls_responder_app.xem4f.test

rtls_responder_app.xem4f.test:: rtls_responder_app.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 rtls_responder_app.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.rtls_responder_app.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,rtls_responder_app.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) rtls_responder_app.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
rtls_responder_app_pem4f.oem4f,copy : package/cfg/rtls_responder_app_pem4f.oem4f
rtls_responder_app_pem4f.sem4f,copy : package/cfg/rtls_responder_app_pem4f.sem4f
