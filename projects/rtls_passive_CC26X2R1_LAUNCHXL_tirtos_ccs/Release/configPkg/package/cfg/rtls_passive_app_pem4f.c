 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/user/Documents/workspace/ti_aoa_workspace/rtls_passive_CC26X2R1_LAUNCHXL_tirtos_ccs/Release/configPkg/package/cfg/rtls_passive_app_pem4f");
