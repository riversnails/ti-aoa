 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/user/Documents/workspace/ti_aoa_workspace/v5_rtls_coordinator_CC26X2R1_LAUNCHXL_tirtos_ccs/Release/configPkg/package/cfg/rtls_coordinator_app_pem4f");
