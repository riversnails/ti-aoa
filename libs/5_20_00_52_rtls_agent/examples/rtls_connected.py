...
class RtlsConnectedExample():
    ...
    def _get_example_parameters(self):
        ...
        example_parameters += f"    AoA Slot Duration                   : {self.angle_of_arrival_params.get('slot_duration', 1)}\n"
                ...
                if 'type' in aoa_data and aoa_data['type'] == "RTLS_CMD_AOA_RESULT_RAW":
                    ...
                    for indx, sample in enumerate(aoa_data['payload']['samples']):
                        ...
                        row = {
                            ...
                            'i': sample_i,
                            'q': sample_q,
                            'slot_duration': self.angle_of_arrival_params.get('slot_duration', 1),
                    ...
                    if len(df_by_channel) == samplesLength:
                        ...
                        if os.path.isfile(csv_file_name): #파일로 값을 넣는부분
        ...
        if enable:
            aoa_params = {
                ...
                "aoa_cc26x2": {
                    ...
                    "aoa_sample_rate": 1,
                    "aoa_sample_size":1,
                    "aoa_sampling_control": int('0x10' if False else '0x11',16),
                    "aoa_sampling_enable": 1,
                    "aoa_pattern_len": 3,#len([0, 1, 2]),
                    "aoa_ant_pattern": [3,4,5]#[0, 1, 2]
                }
            }
